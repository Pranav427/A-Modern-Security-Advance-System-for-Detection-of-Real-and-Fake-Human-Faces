...
def render_sidebar() -> str:
    with st.sidebar:
        ...
        st.divider()
        with st.expander("⚠️ Forensic Boundary Warning"):
            st.caption(
                "This model was trained on StyleGAN vs CelebA-HQ. Because of this, it is highly optimized for GAN-specific high-frequency fingerprints. "
                "It will fail to reliably flag images generated by modern Latent Diffusion networks (e.g., Midjourney, Stable Diffusion, Flux) or active deepfake face-swaps. "
                "For production security systems, we recommend retraining the classifier with a multi-generator dataset."
            )
