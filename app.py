...
def render_prediction_result(
    ...
    with st.expander("⚠️ Forensic Boundary & Generalization Warning"):
        st.warning(
            ...
            "For production security systems, we recommend retraining the classifier with a multi-generator dataset containing diffusion outputs."
        )
